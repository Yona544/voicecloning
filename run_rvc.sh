...
# Variables
GITHUB_USER="USERNAME"  # Change to your GitHub username
...
wget -O dataset_raw/yona/yona_voice.wav "https://raw.githubusercontent.com/${GITHUB_USER}/voicecloning/main/yona_voice.wav"
wget -O dataset_raw/tony/tony.wav "https://raw.githubusercontent.com/${GITHUB_USER}/voicecloning/main/tony.wav"
